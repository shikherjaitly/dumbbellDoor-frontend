      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center mb-8">
          <div className="pt-6 flex">
            <Link
              to="/signup"
              className="flex items-center justify-center px-20 mb-3 py-4 text-sm text-center font-semibold leading-none bg-lime-400 hover:bg-lime-500 transition-all rounded-xl mr-4"
            >
              Sign Up
            </Link>
            <Link
              to="/login"
              className="flex items-center justify-center px-20 mb-3 py-4 text-sm text-center text-black font-semibold bg-sky-400 hover:bg-sky-500 transition-all rounded-xl"
            >
              Login
            </Link>
          </div>
