    ...
    <div>
      <div
        ...
        <div className="pt-6 flex">
          <Link
            to="/signup"
            className="flex items-center justify-center block px-28 mb-3 py-4 text-xl text-center font-lato leading-none bg-lime-300 hover:bg-green-400 transition-all rounded-full mr-4"
          >
            Sign Up
          </Link>
          <Link
            to="/login"
            className="flex items-center justify-center block px-28 mb-3 py-4 text-xl text-center text-black font-lato bg-sky-400 hover:bg-sky-500 transition-all rounded-full"
          >
            Login
          </Link>
        </div>
