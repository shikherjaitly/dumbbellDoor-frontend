      ...
      <div className="container mx-auto w-96 border-2 border-gray-500 rounded-md">
        <div className="max-w-md mx-auto my-10">
          <div className="text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">Login to access your account</p>
          </div>
          <div className="m-7">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                />
                <div className="flex justify-between mb-2">
                  <a href="#!" className="text-sm text-gray-400 focus:outline-none focus:text-indigo-500 hover:text-indigo-500 dark:hover:text-indigo-300 py-1.5 ml-auto">Forgot password?</a>
                </div>
              </div>
              <div className="mb-2">
                <button type="submit" className="w-full px-3 py-4 text-white bg-violet-600 rounded-md focus:bg-violet-800 focus:outline-none">Login</button>
              </div>
